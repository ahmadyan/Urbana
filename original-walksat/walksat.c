...
int main(int argc,char *argv[])
{
	...
	printf("printing out clause[i][j]\n");
	...
	printf("printing false clauses\n");
	for(i=0;i<numclause;i++){
		printf("%d ", false[i]);
	}
	printf("\n");
	printf("printing  numtruelit\n");
	for(i=0;i<numclause;i++){
		printf("%d ", numtruelit[i]);
	}
	printf("\n");
	printf("printing wherefalse\n");
	for(i=0;i<numclause;i++){
		printf("%d ", wherefalse[i]);
	}
	printf("\n");
	
	printf("occurance\n");
	for(i=0;i<numatom;i++){
		printf("%d", numoccurrence[i]);
	}
	printf("\n");
